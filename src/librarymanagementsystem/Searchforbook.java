 ...
 * @author R.M.A
 */
public class Searchforbook extends javax.swing.JFrame {
String bookid, bookname, fname, lname;
float price;
    /**
     * Creates new form Searchforbook
     */
    ...
    private void txtbnKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtbnKeyPressed
     ...
     String Query = ("SELECT * FROM book INNER JOIN written ON book.Book_id = written.Book_id INNER JOIN "
             + "author ON author.Author_id = written.Author_id WHERE book.Book_Name = '"+bookname+"'");
        DBCon.DBConnection();
        {
        try
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Searchforbook.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
